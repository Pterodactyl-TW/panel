    ...
    return (
        <Formik onSubmit={updateGSLToken} initialValues={{ gslToken: '' }}>
            ...
            >
                ...
                <Form>
                    <h2 css={tw`text-2xl mb-4 text-neutral-100`}>GSL 權杖無效！</h2>
                    <p css={tw`mt-4`}>你的遊戲伺服器登入權杖（GSL Token）似乎已失效或過期。</p>
                    <p css={tw`mt-4`}>你可以產生新的權杖並輸入下方欄位，或留空以完全移除它。</p>
                    <div css={tw`sm:flex items-center mt-4`}>
                        <Field
                            name={'gslToken'}
                            label={'GSL 權杖'}
                            description={'請前往 https://steamcommunity.com/dev/managegameservers 產生權杖。'}
                            autoFocus
                        />
                    </div>
