...
@section('content-header')
    <h1>掛載<small>設定並管理伺服器的額外掛載點。</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="text-muted small">用來與其他掛載區分的唯一名稱。</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-muted small">使用者是否應該可以自行掛載此項目？</p>
                            </div>
                        </div>
                    </div>
