...
<div class="row">
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="registered" class="control-label">客戶名字</label>
                        <div>
                            <input type="text" name="name_first" value="{{ $user->name_first }}" class="form-control form-autocomplete-stop">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="registered" class="control-label">客戶姓氏</label>
                        <div>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group no-margin-bottom">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">留空以保持此使用者的密碼不變。若密碼被變更，使用者將不會收到任何通知。</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-xs-12">
        <div class="box box-danger">
            ...
            <div class="box-body">
                <p class="no-margin">必須先確認沒有任何伺服器與此帳號關聯，才能將其刪除。</p>
            </div>
            <div class="box-footer">
                <form action="{{ route('admin.users.view', $user->id) }}" method="POST">
                    {!! csrf_field() !!}
