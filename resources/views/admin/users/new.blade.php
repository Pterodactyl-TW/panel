...
@section('content-header')
    <h1>建立使用者<small>在系統中新增一位使用者。</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="name_first" class="control-label">客戶名字</label>
                        <div>
                            <input type="text" autocomplete="off" name="name_first" value="{{ old('name_first') }}" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name_last" class="control-label">客戶姓氏</label>
                        <div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>為此使用者渲染 Panel 時使用的預設語言。</small></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body">
                    <div class="form-group col-md-12">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>將此設為「是」將授予使用者完整的管理權限。</small></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="alert alert-info">
                        <p>提供使用者密碼是可選的。新使用者的電子郵件會提示使用者在首次登入時建立密碼。若在此提供了密碼，你將需要另尋方式將其提供給使用者。</p>
                    </div>
    ...
    <script>$("#gen_pass_bttn").click(function (event) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $("#gen_pass").html('<strong>已產生密碼：</strong> ' + data).slideDown();
