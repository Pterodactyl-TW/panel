...
@section('content-header')
    <h1>{{ $server->name }}<small>編輯此伺服器的詳細資訊，包括擁有者與容器。</small></h1>
    <ol class="breadcrumb">
            ...
            <form action="{{ route('admin.servers.view.details', $server->id) }}" method="POST">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <p class="text-muted small">字元限制：<code>a-zA-Z0-9_-</code> 及 <code>[空白]</code>。</p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="text-muted small">留空則不為此伺服器指派外部識別碼。外部識別碼應為此伺服器所特有，不可被其他伺服器使用。</p>
                    </div>
                    <div class="form-group">
